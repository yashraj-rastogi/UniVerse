...
"[project]/components/thirdspace/secure-chat-window.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SecureChatWindow({ chatId }) {
    ...
    const [chat, setChat] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SecureChatWindow.useEffect": ()=>{
            const loadChat = {
                "SecureChatWindow.useEffect.loadChat": async ()=>{
                    if (!user) return;
                    const chatData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$thirdspace$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getSecureChat"])(chatId);
                    if (!chatData) {
            ...
            }["SecureChatWindow.useEffect.loadChat"];
            loadChat();
        }
    }["SecureChatWindow.useEffect"], [
        chatId,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SecureChatWindow.useEffect": ()=>{
            if (!chat) return;
            const unsubscribe = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$thirdspace$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["subscribeToMessages"])(chatId, {
                "SecureChatWindow.useEffect.unsubscribe": (msgs)=>{
                    setMessages(msgs);
                    // Scroll to bottom
                    setTimeout({
                        "SecureChatWindow.useEffect.unsubscribe": ()=>{
                    ...
                    }["SecureChatWindow.useEffect.unsubscribe"], 100);
                }
            }["SecureChatWindow.useEffect.unsubscribe"]);
            return ({
                "SecureChatWindow.useEffect": ()=>unsubscribe()
    ...
    const handleSend = async ()=>{
        ...
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$firebase$2f$thirdspace$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["sendMessage"])(chatId, user.uid, newMessage);
        setNewMessage("");
    };
...
_s(SecureChatWindow, "Hc5txtLpUjvWPMa5dArZDbLHcJ8=", false, function() {
    return [
...
_c = SecureChatWindow;
var _c;
__turbopack_context__.k.register(_c, "SecureChatWindow");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_e2183447._.js.map